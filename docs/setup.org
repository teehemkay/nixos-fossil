...
The argument is the DNS name fossil serves on for that host, NOT the NixOS hostname. Use =fossil.exidia.com= for canonical, =s1.fossil.exidia.com= for secondary-1, =s2.fossil.exidia.com= for secondary-2.
