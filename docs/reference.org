...
|-----------------------------------------------+---------------------------------------------------------+----------------------------------------------------------+------------------------------------|
| =fossil-sync.age=                               | Fossil sync user password (cluster-wide)                | Plain text, one line; trailing newline OK                | =bin/new-repo.sh=, sync stored URLs |
...
- =github.com= (SSH, :22) — for =system.autoUpgrade= flake pull from the private repo.
